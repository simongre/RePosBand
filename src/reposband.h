...
#ifndef INCLUDED_reposband_H
#define INCLUDED_reposband_H
 ...
 * of reposband, as in, from pre-2.4.frog-knows days, and thus the
 * references to version numbers may be rather misleading...
 */

/*
 * UNIX reposband Version 5.0
 */

/* Original copyright message follows. */

/*
 * reposband Version 4.8	COPYRIGHT (c) Robert Alan Koeneke
 *
...
/*
 *	 reposband may be copied and modified freely as long as the above
